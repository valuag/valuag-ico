          ...
          <div class="row">
            <div class="col-12 col-lg-6 col-md-12">
              <div class="section-heading">
                ...
                <p class="wow fadeInUp" data-wow-delay="0.4s" style={{ marginLeft: '0' }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis accumsan nisi Ut ut felis congue nisl hendrerit commodo.</p>
              </div>
            ...
            <div class="col-12 col-lg-6 col-md-12">
              <div class="section-heading">
                ...
                <h2 class="wow fadeInUp" data-wow-delay="0.3s">Pre-sale FAQ Questions</h2>
                <p class="wow fadeInUp" data-wow-delay="0.4s" style={{ marginLeft: '0' }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis accumsan nisi Ut ut felis congue nisl hendrerit commodo.</p>
              </div>
